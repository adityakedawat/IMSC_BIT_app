...
class GPA_Calculation : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val aa = ArrayAdapter(this, android.R.layout.simple_spinner_item, sems)
...
//                    gparray[i]=0.0
            ...
            val cgpa= BigDecimal(findcgpa(gparray, totalsem,totalcredits)).setScale(2, RoundingMode.HALF_EVEN)
